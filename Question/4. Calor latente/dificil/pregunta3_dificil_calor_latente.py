...
def generar_pregunta_calor_latente_dificil_3():
    ...
    calor_latente_sublimacion_CO2 = random.uniform(2600, 3000)  # Valor aleatorio en J/g

    # Masa de dióxido de carbono a sublimar en gramos
    masa_CO2_gramos = random.uniform(8, 12)  # Valor aleatorio en gramos
...
respuesta, hint = generar_pregunta_calor_latente_dificil_3()
