...
def generar_pregunta_calor_latente_dificil_2():
    ...
    calor_latente_fusion_plomo = random.uniform(20, 35)  # Valor aleatorio en J/g

    # Masa de plomo a fundir en gramos
    masa_plomo_gramos = random.uniform(10, 20)  # Valor aleatorio en gramos
...
respuesta, hint = generar_pregunta_calor_latente_dificil_2()
