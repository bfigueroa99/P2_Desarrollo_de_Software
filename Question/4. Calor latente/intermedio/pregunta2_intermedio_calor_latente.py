...
def generar_pregunta_calor_latente_intermedia_2():
    ...
    calor_latente_fusion = random.uniform(320, 380)  # Valor aleatorio en J/g

    # Masa de hielo a derretir en gramos
    masa_hielo_gramos = random.uniform(90, 140)  # Valor aleatorio en gramos
...
respuesta, hint = generar_pregunta_calor_latente_intermedia_2()
