...
def generar_pregunta_calculo_numerico_temperatura_kelvin():
    ...
    ruta_archivo_svg = 'Question/SVG_tmp/calculonumerico9_facil_diagrama_pvt.svg'
    ...
    enunciado = f"Si tienes un gas ideal con un volumen de {volumen_litros:.2f} litros a {temperatura_celsius:.2f}°C, ¿cuál sería su temperat-\nura en Kelvin?"
