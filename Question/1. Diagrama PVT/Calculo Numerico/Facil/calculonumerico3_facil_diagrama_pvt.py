...
def generar_pregunta_calculo_numerico_gases_ideales():
    # Especifica la ruta completa del archivo SVG junto con su nombre de archivo.
    ruta_archivo_svg = 'Question/SVG_tmp/calculonumerico3_facil_diagrama_pvt.svg'

    # Crea un lienzo SVG con la ruta del archivo
    dwg = svgwrite.Drawing(ruta_archivo_svg, profile='tiny', size=('600px', '200px'))

    # Genera valores aleatorios para la presión (entre 1 y 10 atmósferas) y la temperatura (entre 200 y 400 Kelvin)
