...
def generar_pregunta_calculo_numerico_moles_gases_ideales():
    ...
    ruta_archivo_svg = 'Question/SVG_tmp/calculonumerico4_facil_diagrama_pvt.svg'

    # Crea un lienzo SVG con la ruta del archivo
    dwg = svgwrite.Drawing(ruta_archivo_svg, profile='tiny', size=('600px', '200px'))

    # Genera valores aleatorios para el volumen (entre 10 y 30 litros), la temperatura (entre 200 y 400 Kelvin) y la presión (entre 1 y 10 atmósferas)
